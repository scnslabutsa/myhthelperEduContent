...
Depósitos del calcio en los tejidos. La calcificación en el seno se puede ver en una mamografía como puntos blancos brillantes, pero no se puede palpar. Hay dos tipos de calcificación del seno: macrocalcificación y microcalcificación. Las macrocalcificaciones son depósitos grandes y generalmente no se relacionan con el cáncer. Las microcalcificaciones son las partículas de calcio que puede encontrarse en un área de células que se multiplican rápidamente. Muchas microcalcificaciones agrupadas, juntas, pueden ser un signo de cáncer. Por esto pueden necesitar seguimiento con más mamografías, o con biopsias. 
...
Un grupo de enfermedades en que las células del cuerpo cambia y crecen sin control. La mayoría de los tipos de células cancerosas forman un bulto, o masa llamada tumor. No todos los tumores son cancerosos. Un tumor que no es cáncer se llama benigno. Un tumor canceroso se llama maligno. Un tumor canceroso (o maligno) puede invadir y destruir tejidos saludables. 
...
Cáncer de seno (mama) que se diseminó del sitio donde comenzó en el seno (conducto lácteo o lóbulo) al tejido sano que la rodea y posiblemente a los ganglios linfáticos y a otras partes del cuerpo. El cáncer ductal invasivo comienza en los conductos lácteos del seno (que llevan la leche hasta el pezón) y el cáncer lobulillar invasivo comienza en los lóbulos del seno (gládulas que produce leche).


**Cáncer de Seno Localizado**

Cuando no hay signos de que el cáncer se haya extendido afuera del seno. En otras palabras, el cáncer que está en el seno donde comenzó y no se ha extendido a tejidos cercanos, ganglios linfáticos, u otras partes del cuerpo. También llamado cáncer local.
...
Cáncer que se forma en los tejidos del seno. El tipo de cáncer de seno (mama) más común es el carcinoma ductal, que empieza en el revestimiento de los conductos del seno (tubos delgados que llevan leche desde los lobulillos del seno hasta el pezón). Otro tipo de cáncer de seno es el carcinoma lobulillar, que empieza en los lobulillos (glándulas que producen leche). El cáncer de seno invasivo es el que se diseminó desde el sitio en que empezó en los conductos del seno o en los lobulillos hasta el tejido normal circundante. El cáncer de seno se presenta tanto en hombres como en mujeres, aunque el cáncer de seno masculino es poco frecuente.
...
Un tipo de cáncer de seno en la que las células del tumor no tienen receptores de estrógeno, receptores de progesterona o grandes cantidades de la proteína HER2/neu en su superficie. Es muy importante saber si el cáncer de seno es triple negativo para planificar el tratamiento. También se llama cáncer de seno ER-negativo, PR-negativo, HER2/neu-negativo y CSTN.
...
Pérdida de peso corporal y masa muscular causada por perdida de apetito y nutrición pobre.


**Carcinoma Ductal in Situ (CDIS)**

Afección no invasiva en la que las células anormales se encuentran localizadas en el revestimiento de un conducto del seno. Las células anormales no se diseminaron fuera del conducto a otros tejidos del seno. También se llama carcinoma ductal in situ y CDIS.
...
Un tubo pequeño usado para aplicar fluidos (o remover fluidos) del cuerpo, como un catéter intravenoso.
...
Un doctor que tiene una formación especial para realizar una cirugía, para remuever o reparar una parte del cuerpo al operar al paciente. Pueden remover tumores o partes del cuerpo afectadas por una enfermedad. 


**Cirujano Oncólogo**

Un doctor que tiene una formación especializada para realizar biopsias y otros procedimientos quirúrgicos (cirugías) en pacientes con cáncer.


**Citometría de Flujo**

Método de laboratorio para determinar el número de células, el porcentaje de células vivas y ciertas características de las células (como el tamaño y la forma) en una muestra de sangre, médula ósea u otro tejido. También sirve para identificar marcadores tumorales, como antígenos, en la superficie celular. Las células se tiñen con un tinte sensible a la luz, se colocan en un líquido y luego se pasan una a una por un rayo de luz. Las mediciones se basan en la manera en que las células teñidas responden a la luz. La citometría de flujo se usa en investigación básica y para el diagnóstico y tratamiento de enfermedades, como el cáncer.


**Citopatólogo o Patólogo**

Profesional de la medicina que se especializa en diagnosticar enfermedades examinando células y tejidos bajo un microscopio. Típicamente trabajan en hospitales, laboratorios y consultorios médicos, y son responsables de evaluar muestras para detectar cáncer y otras enfermedades. También se llama anatomopatólogo, especialista en anatomía patológica e histopatólogo.
...
Condiciones o cambios en el tejido del seno que son benignos (no cancerosos) y que pueden resultar en masas o bultos u otras anormalidades. Los signos y síntomas de la enfermedad benigna del seno incluyen quistes o bultos irregulares, hinchazón o malestar en los senos, enrojecimiento o engrosamiento de la piel y secreción del pezón. La mayoría de las afecciones benignas del seno no aumentan el riesgo de cáncer de seno. También se llama displasia mamaria. Sin embargo, si presenta alguno de estos signos acuda con su doctor para descartar algo serio.


**Conducto del Seno (Conductos de leche, Conducto)**

Tubo delgado del seno que lleva la leche de los lobulillos (glándulas que producen leche) hasta el pezón. También se llama conducto galactóforo.
